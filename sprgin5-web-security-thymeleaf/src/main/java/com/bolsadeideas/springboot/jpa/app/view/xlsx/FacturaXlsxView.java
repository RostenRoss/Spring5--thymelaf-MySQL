package com.bolsadeideas.springboot.jpa.app.view.xlsx;
...
import com.bolsadeideas.springboot.jpa.app.entity.ItemFactura;
...
public class FacturaXlsxView extends AbstractXlsxView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		Factura factura=(Factura)model.get("factura"); //factura hace referencia al objeto guardado en el model x el controladors
		
		Sheet sheet = workbook.createSheet("Factura Spring"); //crea la planilla
		...
		///////////otra manera de crear celdas y filas de manera encadenada
		
		sheet.createRow(4).createCell(0).setCellValue(mensaje.getMessage("text.factura.ver.datos.factura"));
		sheet.createRow(5).createCell(0).setCellValue(mensaje.getMessage("text.factura.ver.datos.folio")+": "+factura.getId());
		sheet.createRow(6).createCell(0).setCellValue(mensaje.getMessage("text.factura.ver.datos.descripcion")+": "+factura.getDescripcion());
		sheet.createRow(7).createCell(0).setCellValue(mensaje.getMessage("text.factura.ver.datos.fecha")+": "+factura.getCreateAt());
		...
		filatotal.createCell(2).setCellValue(mensaje.getMessage("text.factura.form.total")+": ");
