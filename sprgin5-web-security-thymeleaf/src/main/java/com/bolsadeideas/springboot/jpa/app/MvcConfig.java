...
public class MvcConfig implements WebMvcConfigurer/*extends WebMvcConfigurerAdapter*/ {
	...
	@Bean
	public LocaleChangeInterceptor localeChangeIntercepor() {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(localeChangeIntercepor());
	}
	...
	public Jaxb2Marshaller jaxb2Marshaller() {
		...
		marshaller.setClassesToBeBound(new Class[] {com.bolsadeideas.springboot.jpa.app.view.xml.ClienteList.class});
		return marshaller;
	}
}
